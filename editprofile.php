<?php
  ...
  if($userData->image == "") { // Coloca uma imagem padrão caso o usuário esteja sem imagem
...
<div id="main-container" class="container-fluid edit-profile-page">
    <div class="col-md-12"> <!-- Bootstrap -->
      <form action="<?= $BASE_URL ?>user_process.php" method="POST" enctype="multipart/form-data"> <!-- " enctype="multipart/form-data" " obrigatório para o envio de imagens por formulário -->
        ...
        <div class="row">
          <div class="col-md-4"> <!-- Bootstrap -->
            ...
            <div class="form-group">
              <label for="email">E-mail:</label> <!-- O atributo "readonly" não permite edição -->
